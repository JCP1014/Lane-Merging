...
def dp_compute_entering_time(a, b, c, W_same, W_diff, last_X, last_Y):
    ...
    for i in range(1, alpha+1):
        for j in range(1, beta+1):
            for k in range(1, gamma+1):
                L_AB[i][j][k] = min(
                    Sol((max(a[i].time, L_AB[i-1][j-1][k].time[0]+W_same),
                         max(b[j].time, L_AB[i-1][j-1][k].time[1]+W_same)), 'AB', 0, 'XY'),
                    Sol((max(a[i].time, max(b[j].time, L_AB[i-1][j-1][k].time[0]+W_diff) +
                             W_diff), L_AB[i-1][j-1][k].time[1]), 'AB', 0, 'XX'),
                    Sol((max(a[i].time, L_AC[i-1][j-1][k].time[0]+W_same),
                         max(b[j].time, L_AC[i-1][j-1][k].time[1]+W_diff)), 'AC', 0, 'XY'),
                    Sol((max(a[i].time, L_BB[i-1][j-1][k].time[0]+W_diff),
                         max(b[j].time, L_BB[i-1][j-1][k].time[1]+W_same)), 'BB', 0, 'XY'),
                    Sol((max(a[i].time, max(b[j].time, L_BB[i-1][j-1][k].time[0]+W_same) +
                             W_diff), L_BB[i-1][j-1][k].time[1]), 'BB', 0, 'XX'),
                    Sol((max(a[i].time, L_BC[i-1][j-1][k].time[0]+W_diff),
                         max(b[j].time, L_BC[i-1][j-1][k].time[1]+W_diff)), 'BC', 0, 'XY'),
                    key=get_obj
                )
                L_AC[i][j][k] = min(
                    Sol((max(a[i].time, L_AB[i-1][j][k-1].time[0]+W_same),
                         max(c[k].time, L_AB[i-1][j][k-1].time[1]+W_diff)), 'AB', 0, 'XY'),
                    Sol((max(a[i].time, L_AC[i-1][j][k-1].time[0]+W_same),
                         max(c[k].time, L_AC[i-1][j][k-1].time[1]+W_same)), 'AC', 0, 'XY'),
                    Sol((max(a[i].time, L_BB[i-1][j][k-1].time[0]+W_diff),
                         max(c[k].time, L_BB[i-1][j][k-1].time[1]+W_diff)), 'BB', 0, 'XY'),
                    Sol((max(a[i].time, L_BC[i-1][j][k-1].time[0]+W_diff),
                         max(c[k].time, L_BC[i-1][j][k-1].time[1]+W_same)), 'BC', 0, 'XY'),
                    key=get_obj
                )
                L_BC[i][j][k] = min(
                    Sol((max(b[j].time, L_AB[i][j-1][k-1].time[0]+W_diff),
                         max(c[k].time, L_AB[i][j-1][k-1].time[1]+W_diff)), 'AB', 0, 'XY'),
                    Sol((max(b[j].time, L_AC[i][j-1][k-1].time[0]+W_diff),
                         max(c[k].time, L_AC[i][j-1][k-1].time[1]+W_same)), 'AC', 0, 'XY'),
                    Sol((max(b[j].time, L_BB[i][j-1][k-1].time[0]+W_same),
                         max(c[k].time, L_BB[i][j-1][k-1].time[1]+W_diff)), 'BB', 0, 'XY'),
                    Sol((L_BB[i][j-1][k-1].time[0], max(c[k].time, max(b[j].time, L_BB[i][j-1][k-1].time[1]+W_same)+W_diff)), 'BB', 0, 'YY'),
                    Sol((max(b[j].time, L_BC[i][j-1][k-1].time[0]+W_same),
                         max(c[k].time, L_BC[i][j-1][k-1].time[1]+W_same)), 'BC', 0, 'XY'),
                    Sol((L_BC[i][j-1][k-1].time[0], max(c[k].time, max(b[j].time, L_BC[i][j-1][k-1].time[1]+W_diff)+W_diff)), 'BC', 0, 'YY'),
                    key=get_obj
                )
                if j >= 2:
                    L_BB[i][j][k] = min(
                        Sol((max(b[j-1].time, L_AB[i][j-2][k].time[0]+W_diff),
                             max(b[j].time, L_AB[i][j-2][k].time[1]+W_same)), 'AB', 0, 'XY'),
                        Sol((max(b[j].time, L_AB[i][j-2][k].time[0]+W_diff),
                             max(b[j-1].time, L_AB[i][j-2][k].time[1]+W_same)), 'AB', 0, 'YX'),
                        Sol((max(b[j].time, max(b[j-1].time, L_AB[i][j-2][k].time[0]+W_diff) +
                                 W_same), L_AB[i][j-2][k].time[1]), 'AB', 0, 'XX'),
                        Sol((max(b[j-1].time, L_AC[i][j-2][k].time[0]+W_diff),
                             max(b[j].time, L_AC[i][j-2][k].time[1]+W_diff)), 'AC', 0, 'XY'),
                        Sol((max(b[j].time, L_AC[i][j-2][k].time[0]+W_diff),
                             max(b[j-1].time, L_AC[i][j-2][k].time[1]+W_diff)), 'AC', 0, 'YX'),
                        Sol((max(b[j-1].time, L_BB[i][j-2][k].time[0]+W_same),
                             max(b[j].time, L_BB[i][j-2][k].time[1]+W_same)), 'BB', 0, 'XY'),
                        Sol((max(b[j].time, L_BB[i][j-2][k].time[0]+W_same),
                             max(b[j-1].time, L_BB[i][j-2][k].time[1]+W_same)), 'BB', 0, 'YX'),
                        Sol((max(b[j].time, max(b[j-1].time, L_BB[i][j-2][k].time[0]+W_same) +
                                 W_same), L_BB[i][j-2][k].time[1]), 'BB', 0, 'XX'),
                        Sol((L_BB[i][j-2][k].time[0], max(b[j].time, max(b[j-1].time,
                                                                    L_BB[i][j-2][k].time[1]+W_same)+W_same)), 'BB', 0, 'YY'),
                        Sol((max(b[j-1].time, L_BC[i][j-2][k].time[0]+W_same),
                             max(b[j].time, L_BC[i][j-2][k].time[1]+W_diff)), 'BC', 0, 'XY'),
                        Sol((max(b[j].time, L_BC[i][j-2][k].time[0]+W_same),
                             max(b[j-1].time, L_BC[i][j-2][k].time[1]+W_diff)), 'BC', 0, 'YX'),
                        Sol((L_BC[i][j-2][k].time[0], max(b[j].time, max(b[j-1].time,
            ...
            if last_X[1] < last_Y[1]:
                ...
                if len(b) > 2:
                    ...
                    for i in range(3, len(b), 2):
                        ...
                        schedule_BY.append(Vehicle(b[i+1].id, max(b[i+1].time, schedule_BY[-1].time+W_same)))
            else:
                if last_Y[0] == '':
                ...
                if len(b) > 2:
                    ...
                    for i in range(3, len(b), 2):
                        ...
                        schedule_BX.append(Vehicle(b[i+1].id, max(b[i+1].time, schedule_BX[-1].time+W_same)))
    ...
    while traci.simulation.getMinExpectedNumber() > 0:  # The number of vehicles which are in the net plus the ones still waiting to start. 
        ...
        if step == period:
            if traci.lanearea.getLastStepVehicleNumber("dA") > 0 and traci.lanearea.getLastStepVehicleNumber("dB") > 0 and traci.lanearea.getLastStepVehicleNumber("dC") > 0:
                ...
                print('b_all', b_all)
                print('c_all', c_all)
                schedule_A, schedule_BX, schedule_BY, schedule_C = schedule_by_num_window(a_all, b_all, c_all, W_same, W_diff, window_size)
        ...
        if len(schedule_A) > 0 and traci.vehicle.getPosition(schedule_A[0].id)[0] >= junction_x:
            print('leaveA', schedule_A[0])
            schedule_A.remove(schedule_A[0])
            leaveA = True
        if len(schedule_BX) > 0 and traci.vehicle.getPosition(schedule_BX[0].id)[0] >= junction_x:
            print('leaveBX', schedule_BX[0])
            schedule_BX.remove(schedule_BX[0])
            leaveBX = True
        if len(schedule_C) > 0 and traci.vehicle.getPosition(schedule_C[0].id)[0] >= junction_x:
            print('leaveC', schedule_C[0])
            schedule_C.remove(schedule_C[0])
            leaveC = True
        if len(schedule_BY) > 0 and traci.vehicle.getPosition(schedule_BY[0].id)[0] >= junction_x:
            print('leaveBY', schedule_BY[0])
            schedule_BY.remove(schedule_BY[0])
            leaveBY = True
