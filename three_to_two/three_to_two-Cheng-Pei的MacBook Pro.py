...
def main():
    ...
    try:
        ...
        pA = float(sys.argv[1])     # lambda for Poisson distribution
        pB = float(sys.argv[1])     # lambda for Poisson distribution
        pC = float(sys.argv[1])     # lambda for Poisson distribution
    except:
